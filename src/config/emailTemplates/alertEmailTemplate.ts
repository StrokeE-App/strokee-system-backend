export const alertEmailTemplate = (firstName: string, lastName: string): string => {
...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_image_1 .v-container-padding-padding { padding: 45px 10px 10px !important; } #u_content_heading_2 .v-font-size { font-size: 20px !important; } #u_content_text_1 .v-container-padding-padding { padding: 10px !important; } }
    </style>
...
<table id="u_content_heading_2" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table role="presentation" width="100%"><tr><td><![endif]-->
    <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 30px; font-weight: 400;"><span> <span>🚑 Informaci&oacute;n sobre el estado de su familia</span> </span></h1>
...
<p style="line-height: 140%; text-align: left; margin: 0px;" data-start="93" data-end="111">&nbsp;</p>
<div>
<div style="text-align: left;">Queremos informarle que ${firstName} ${lastName} ha sufrido un accidente cerebrovascular y en este momento est&aacute; siendo trasladado a la Cl&iacute;nica Imbanaco para recibir atenci&oacute;n m&eacute;dica inmediata.</div>
<div style="text-align: left;">&nbsp;</div>
<div style="text-align: left;">
<div>
<div>El equipo m&eacute;dico de la Cl&iacute;nica Imbanaco est&aacute; preparado para atenderlo.</div>
<div>&nbsp;</div>
<div>
<div>
<div>Si necesita m&aacute;s informaci&oacute;n, no dude en comunicarse con la cl&iacute;nica.</div>
</div>
</div>
</div>
</div>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-font-size" style="font-size: 14px; color: #616161; letter-spacing: 0px; line-height: 140%; text-align: left; word-wrap: break-word;">
    <div>
<div>Atentamente,</div>
<div>StrokeE System</div>
</div>
  </div>
